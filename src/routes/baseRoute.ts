...
export default abstract class baseRoute<TKey, TEntity extends baseEntity<TKey>, TDTO extends baseDTO<TKey, TEntity>, TRepository extends baseRepositoryInterface<TKey,TEntity>,TService extends baseServiceInterface<TKey,TEntity, TDTO, TRepository>, TController extends baseController<TKey,TEntity,TDTO,TRepository,TService>>
